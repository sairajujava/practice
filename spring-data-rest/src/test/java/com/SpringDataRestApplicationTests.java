 ...
 * 
 * import com.model.Employee; import com.repository.EmployeeRepository; import
 * com.utils.DateUtils;
 * 
 * @SpringBootTest
 * 
 ...
 * 
 * @Test public void saveEmp() {
 * 
 * Employee emp =
 * Employee.builder().id(100L).name("Swati").salary("60000").address("Pune")
 ...
 * 
 * Employee emp =
 * Employee.builder().id(4L).name("Giri").salary("60000").address("Proddatur")
 * .dob(DateUtils.convertStrDateToSqlDate("1990-10-23"))
 * .doj(DateUtils.convertStrDateToSqlDate("2021-10-23")).build();
 * 
 * // Type 1 employeeRepository.save(emp);
 * 
 * // Type 2 // employeeRepository.updateEmpinfo("Janaki","Proddatur" ,5L);
 * 
 * }
 * 
 * }
